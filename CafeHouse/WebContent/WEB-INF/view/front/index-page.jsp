      ...
      <div class="container">
        <div class="row">
          <div class="tm-top-header-inner">
            ...
            <nav class="tm-nav">
              <ul>
                <li><a href="index-page" class="active">Home</a></li>
      ...
      <div class="container" id="main">
        <section class="tm-section row">
          <div class="col-lg-9 col-md-9 col-sm-8">
            ...
            Espresso is a type of coffee made by brewing in a special way. It is made by forcing a small 
            amount of nearly boiling water under pressure through finely ground coffee beans. It has a higher 
            concentration of suspended and dissolved solids which makes it thicker and much stronger. Espresso 
            has more caffeine per unit volume than most other types of coffee, but is served in smaller sizes. 
            ...
            <a href="http://www.historyofcoffee.net/coffee-history/history-of-espresso/" target="_blank" class="tm-more-button margin-top-30">Read More</a> 
          </div>
          ...
          <c:forEach var="category" items="${categoryList}">
            ...
            <div class="tm-popular-item">
              ...
              <div class="tm-popular-item-description">
                ...
                <div class="order-now-container" style="justify-content: center; display: flex;">
                  <a href="menu-page" class="order-now-link tm-handwriting-font">Order Now</a>
                </div>
              </div>              
            </div>
...
<!--                 <li><a href="index-page">Home</a></li> -->
				<li><a href="administration/category-list">Admin Panel</a></li>
                <li><a href="about-page">About Us</a></li>
