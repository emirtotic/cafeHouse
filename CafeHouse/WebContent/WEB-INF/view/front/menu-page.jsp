...
<head>
  ...
  <title>Cafe House Menu Page</title>
<!-- 
Cafe House Template
  ...
  <body>
          ...
          <div class="tm-top-header-inner">
            ...
            <nav class="tm-nav">
              <ul>
                ...
                <li><a href="menu-page" class="active">Menu</a></li>
    ...
    <section class="tm-welcome-section">
      ...
      <div class="row tm-welcome-content">
          ...
          <a href="#main" class="tm-more-button tm-more-button-welcome">Our Menus</a>      
        </div>
          ...
          <div>
              ...
              <div class="tm-position-relative margin-bottom-30">              
                <nav class="tm-side-menu">
                  ...
                  <c:forEach var="category" items="${categoryList}">
                    ...
                    <li><a href="coffee-page-filter?id=${category.id}&type=category">${category.name}</a></li>
            ...
            <div class="tm-menu-product-content col-lg-9 col-md-9"> <!-- menu content -->
              ...
              <c:forEach var="coffee" items="${coffeeList}"> 
                    ...
                    <li><a href="coffee-page-filter?id=${category.id}&type=category" class="active">${category.name}</a></li>
              
              <div class="tm-product">
                <img src="${coffee.image}" height="100" width="100" alt="Product">
                <div class="tm-product-text">
                  <h3 class="tm-product-title">${coffee.name}</h3>
                  <p class="tm-product-description">${coffee.description}</div>
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"> ${coffee.price} euros</a>
                </div>
              </div>
