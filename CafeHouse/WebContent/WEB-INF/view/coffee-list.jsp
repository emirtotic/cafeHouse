						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">All Coffes</h3>
									<div class="card-tools">


										<a href="coffee-form" class="btn btn-success"> <i
											class="fas fa-plus-square"></i> Add new Coffee
										</a>
									</div>
								</div>
								<!-- /.card-header -->
										...
										<tbody id="sort-list">
											...
											<c:forEach var="coffee" items="${coffeeList}">
												...
												<tr>
													...
													<td><strong>${coffee.category.name}</strong></td>
													<td><strong>${coffee.image}</strong></td>
													<td><strong>${coffee.price} €</strong></td>
													<td><strong>${coffee.description}</strong></td>

													<td class="text-center">
														<div class="btn-group">
															<a href="coffee-form-update?id=${coffee.id}"
																class="btn btn-info"> <i class="fas fa-edit"></i>
															</a>
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${coffee.id}">
												...
												<div class="modal fade" id="delete-modal-${coffee.id}">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title">Delete this Coffee</h4>
															...
															<div class="modal-body">
																<p>Are you sure you want to delete coffee?</p>
																<strong></strong>
															</div>
															<div class="modal-footer justify-content-between">
																<button type="button" class="btn btn-default"
																	data-dismiss="modal">Cancel</button>
																<a href="coffee-delete?id=${coffee.id}"
